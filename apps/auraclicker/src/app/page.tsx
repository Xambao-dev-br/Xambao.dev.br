...
//Next JS implementado porcamente
let apocar: number = 0;
function App() {
  const [ranking, setRanking] = useState([])
  const [nome, setNome]=useState('')
  async function salvarAura(nome: string, aura: number){
  ...
  return (
    <>
      <section id="center">
        <div className="hero">
          <img className="mt-[20px] w-40 h-40" src={''} />
        </div>
        <div>
        ...
        <button onClick={saveRanking}>Salve auras</button>
